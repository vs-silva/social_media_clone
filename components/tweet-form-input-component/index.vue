  ...
  <div>
    ...
    <div class="flex items-center flex-shrink-0 p-4 pb-0">
      ...
      <div class="flex w-12 items-top">
        <img :src="props.profileImage" alt="profile_image" class="inline-block w-10 h-10 rounded-full" />
      </div>
    ...
    <div class="flex p-2 pl-14">
      ...
      <div class="flex w-full text-white">
        ...
        <div class="p-2 text-blue-400 rounded-full hover:bg-blue-50 dark:hover:bg-dim-800 cursor-pointer" @click.prevent="toggleMediaInput">
      ...
      <div class="ml-auto">
        <button-component
            :size="`sm`"
            :disabled="isDisabled"
            @button-component-click.prevent="() => emit(TweetFromInputEventTypeConstants.SUBMIT_TWEET, {tweetText, mediaFile})"
        >
...
import {TweetFromInputEventTypeConstants} from "./constants/tweet-from-input-event-type.constants";
import ButtonComponent from "../button-component/index.vue";

const emit = defineEmits([
  TweetFromInputEventTypeConstants.SUBMIT_TWEET
]);
...
const isDisabled = computed(() => !tweetText.value.trim());

function handleMediaChange(inputElement: HTMLInputElement): void {
...
function toggleMediaInput(): void {
  (mediaInput.value as HTMLInputElement).click();
}
